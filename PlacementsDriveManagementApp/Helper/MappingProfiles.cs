    ...
    public class MappingProfiles: Profile
    {
        public MappingProfiles()
        {
            ...
            CreateMap<Application, ApplicationDetailDto>()
                ...
                .ForMember(dest => dest.AppliedDate, opt => opt.MapFrom(src => src.AppliedDate.ToString("d/M/yyyy h:mm tt")))
                .ForMember(dest => dest.InterviewSlot, opt => opt.MapFrom(src => src.InterviewSlot.HasValue ? src.InterviewSlot.Value.ToString("d/M/yyyy h:mm tt") : ""))
